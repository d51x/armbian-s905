...
PS в ручную я запустил систему с emmc, а теперь я пытаюсь автоматизировать этот процесс скриптом. Скрипт основан на armbian-install.sh, сильно упрощен. Текущий скрипт еще имеет ошибки и не работает )))
